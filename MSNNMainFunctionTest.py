...
sleeppicturePath = "D:/PyCharm Community Edition 2020.1.1/sleep/SHNN - TL/result/sleeppicture"
feature_path = "D:/PyCharm Community Edition 2020.1.1/sleep/SHNN - TL/result/feature_picture"
lstm_picture = "D:/PyCharm Community Edition 2020.1.1/sleep/SHNN - TL/result/lstm_picture"
...
if __name__ == '__main__':
    ...
    # standardscaler = pickle.load(open(scaler_path + scaler_files[0], 'rb'))
    # PlotSleepPicture(model, standardscaler, eeg_data, labels, sleeppicturePath, "1_")
